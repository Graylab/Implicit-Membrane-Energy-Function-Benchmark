...
def combiningallfiles(peptide_list):
    ...
    for element_num in range(len(peptide_list)):
        ...
        start_index = ['-50.000000','-40.000000','-30.000000', '-20.000000', '-10.000000','10.000000']
        end_index = ['-40.000000','-30.000000', '-20.000000', '-10.000000', '10.000000','30.000000']#[-3, -2, -1, 0, 0, 0, 1, 2]
    ...
    if (  Options.which_tests == "all" ): 
       ...
       for name in test_names: 
           if name not in all_sub_tests: 
                  ...
                  datadir = config.benchmark_path + "data/" + Options.energy_fxn + "/" + name + "/high_dG_values_for_DE/"
                  print(datadir)
