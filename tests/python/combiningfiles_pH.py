...
def combiningallfiles(datadir, peptide_list, energy_fxn):
    ...
    for element_num in range(len(peptide_list)):
        ...
        end_index = ['10.000000','20.000000','30.000000', '40.000000','50.000000','60.000000']#, '-20.000000', '-10.000000',
        ...
        print("pH is: "+pH)
        list_with_dash = ["LK",'1b4v','1h0a','1q4g','1q4g','1rhz','2hih','2ziy','3a7k','3hyw','3hyw','3i9v','3j5p','3jw8']
        if(peptide_name not in list_with_dash):
        ...
        if(pH=='8'):
            ...
            label0 = peptide_list[element_num]+'/'+peptide_name+'_disordered_'+energy_fxn+'_' + \
                str(end_index[0])+'_'+str(start_index[0])+'_landscape.dat'
            df0 = pd.read_csv(label0)
            label1 = peptide_list[element_num]+'/'+peptide_name+'_disordered_'+energy_fxn+'_' + \
            ...
            label0 = datadir + '/' + peptide_list[element_num]+'/'+peptide_name+'_'+energy_fxn+'_' + \
                str(end_index[0])+'_'+str(start_index[0])+'_landscape.dat'
            df0 = pd.read_csv(label0)
            label1 = datadir + '/' + peptide_list[element_num]+'/'+peptide_name+'_'+energy_fxn+'_' + \
                str(end_index[1])+'_'+str(start_index[1])+'_landscape.dat'
            df1 = pd.read_csv(label1)

            label2 = peptide_list[element_num]+'/'+peptide_name+'_'+energy_fxn+'_' + \
                str(end_index[2])+'_'+str(start_index[2])+'_landscape.dat'
            df2 = pd.read_csv(label2)
            label3 = peptide_list[element_num]+'/'+peptide_name+'_'+energy_fxn+'_' + \
                str(end_index[3])+'_'+str(start_index[3])+'_landscape.dat'
            df3 = pd.read_csv(label3)
            label4 = peptide_list[element_num]+'/'+peptide_name+'_'+energy_fxn+'_' + \
                str(end_index[4])+'_'+str(start_index[4])+'_landscape.dat'
            df4 = pd.read_csv(label4)
            label5 = peptide_list[element_num]+'/'+peptide_name+'_'+energy_fxn+'_' + \
                str(end_index[5])+'_'+str(start_index[5])+'_landscape.dat'
            df5 = pd.read_csv(label5)
...
def combiningchargestatefiles(datadir,peptide_list, energy_fxn):
    ...
    for element_num in range(len(peptide_list)):
        ...
        #fr = open(label1,'w')
        if(pH=="8"):
            label0 = peptide_list[element_num] + '/' + peptide_name + '_disordered_'+energy_fxn+'_'+str(
            ...
            # print(df0)
            label1 = peptide_list[element_num] + '/' + peptide_name + '_disordered_'+energy_fxn+'_'+str(
            ...
            label0 = datadir + '/' + peptide_list[element_num] + '/' + peptide_name + '_'+energy_fxn+'_'+str(
                end_index[0])+'_'+str(start_index[0])+'_chargestatevariation.dat'
            df0 = pd.read_csv(label0)
            # print(df0)
            df0 = df0.replace("-nan", 0)
            #print(df0)
            label1 = datadir + '/' + peptide_list[element_num] + '/' + peptide_name + '_'+energy_fxn+'_'+str(
                end_index[1])+'_'+str(start_index[1])+'_chargestatevariation.dat'
            df1 = pd.read_csv(label1)
            df1 = df1.fillna(0)
    ...
    if (Options.which_tests == "all"):
        ...
        for name in test_names:
            if name not in all_sub_tests:
                ...
                wt_fa_water_to_bilayer = ["1.629"]#,"1.5"]#,"1.50"]  # ,"0.90","1.1","1.3","1.5"]
                wt_f_elec_bilayer = ["0.136"]#,"0.05","0.07","0.10"]
                wt_fa_imm_elec = ["-1.561"]#,"0.10"]#["0.02","0.05","0.07","0.10"]
                    ...
                    for j in range(len(wt_f_elec_bilayer)):
                        for k in range(len(wt_fa_imm_elec)):
                            ...
                            datadir = '/home/rsamant2/scratch16-jgray21/rsamant2/' + "data/"+ \
                                    Options.energy_fxn + "/" + name + "/weights_from_test7_v6/"
                            ...
                            if(name == "tm-peptide-tilt-angle"):
                                ...
                                peptide_list = ['1b4v_h1','1q4g_h1','1q4g_h2','1q4g_h3','1q4g_h4','1rhz_h1','2hih_h1','2ziy_h1','3a7k_h1','3hyw_h1','3hyw_h2','3i9v_h1','3j5p_h1','3jw8_h1' ]
...
#                                                'pHLIP-v9_4', 'pHLIP-v9_8', 'pHLIP-v10_4', 'pHLIP-v10_8', 'pHLIP-v11_4', 'pHLIP-v11_8', 'pHLIP-v12_4', 'pHLIP-v12_8', 'pHLIP-v13_4', 'pHLIP-v13_8', 'pHLIP-v14_4', 'pHLIP-v14_8', 'pHLIP-v15_4', 'pHLIP-v15_8', 'pHLIP-v16_4', 'pHLIP-v16_8']
                                peptide_list = ['pHLIP-v4_8','pHLIP-v15_8','pHLIP-v16_8']#['pHLIP-v1_4','pHLIP-v2_4','pHLIP-v3_4','pHLIP-v4_4','pHLIP-v5_4','pHLIP-v6_4','pHLIP-v7_4','pHLIP-v8_4','pHLIP-v9_4','pHLIP-v10_4','pHLIP-v11_4','pHLIP-v12_4','pHLIP-v14_4','pHLIP-v15_4','pHLIP-v16_4']

                                #peptide_list = ['pHLIP-v1_8','pHLIP-v2_8','pHLIP-v3_8','pHLIP-v4_8','pHLIP-v5_8','pHLIP-v6_8','pHLIP-v7_8','pHLIP-v8_8',
                                #                'pHLIP-v9_8','pHLIP-v10_8','pHLIP-v11_8','pHLIP-v12_8','pHLIP-v14_8','pHLIP-v15_8','pHLIP-v16_8']
