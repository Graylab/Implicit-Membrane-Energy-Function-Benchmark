...
def main( args ): 
	...
	if ( "sequence-recovery" in test_names ): 
		...
		datadir = '/home/rsamant2/scratch16-jgray21/rsamant2/' + "data/"+ \
									Options.energy_fxn + "/sequence-recovery" + "/weights_from_test7/"
		...
		arguments = s.substitute( natives="natives.list", designed="designed.list", outfile=output_file, databasefile=database_file )
		if ( restore == False ): 
