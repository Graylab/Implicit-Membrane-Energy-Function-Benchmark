...
def run_peptide_energy_landscape_calc( energy_fxn, config, test_name, targets, xml, pH_mode=False, pH=7 ): 
	...
	list_of_targets = targets_path + "target1.list"
	...
	outdir = config.benchmark_path + "data/" + energy_fxn + "/" + test_name + "/repeating_franklin2019_with_pH_depth_dependent_v2"
	...
	for case in test_cases:
		...
		start_z = ["-60","-50","-20","-10","0","-40","-30","10","20"]#,"-50","-40","-30","-20","-10","0","10","20","30","40"] #["-40", "-30", "-20", "-10", "0", "10", "20", "30"]
		end_z = ["-50","-40","-10","0","10","-30","-20","20","30"]#,"-40","-30","-20","-10","0","10","20","30","40","50"] #-30", "-20", "-10", "0", "10", "20", "30", "40"]
