...
import make_peptide_energy_landscape_differentwts
import make_peptide_energy_landscape_differentwts_titration
import make_protein_energy_landscape
import make_protein_energy_landscape_diffwts
import make_asymm_docked_complexes
import make_designed_protein_scaffolds
import make_refined_decoys
import make_refined_decoys_pH
import predict_hydrophobic_length
import predict_hydrophobic_length_diffwts
import predict_ddG
...
def main( args ): 
        ...
        if ( "adsorbed-peptide-tilt-angle" in test_names ): 
                ...
                if(Options.energy_fxn == "franklin2021"):
                        ...
                        # for iter in range( 1,29 ):
                        #         make_peptide_energy_landscape_differentwts_titration.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "adsorbed-peptide-tilt-angle", "tilt_angle/ALA_pentapeptide", "tests/xml/make_depth_vs_helix_rot_energy_landscape_pH.xml", True, (iter)*0.50 )
                else:
                        make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "adsorbed-peptide-tilt-angle", "tilt_angle/A2_native_surface_ahelices", "tests/xml/make_depth_vs_helix_rot_energy_landscape_f19.xml" )
                        make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "adsorbed-peptide-tilt-angle", "tilt_angle/A4_designed_surface_ahelices", "tests/xml/make_depth_vs_helix_rot_energy_landscape_f19.xml" )
        #Test #2b: Tilt angles and depth for amphiphilic peptides
        if( "amphiphilic-peptide-tilt-angle" in test_names ):
                
                if(Options.energy_fxn == "franklin2019"):
                        make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "amphiphilic-peptide-tilt-angle", "tilt_angle/A6_AmphiScan_pdbs", "tests/xml/make_depth_vs_helix_rot_energy_landscape_f19.xml" )
                else:
                        make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "amphiphilic-peptide-tilt-angle", "tilt_angle/A6_AmphiScan_pdbs", "tests/xml/make_depth_vs_helix_rot_energy_landscape.xml" )
        ...
        if ( "protein-tilt-angle" in test_names ): 
                ...
                make_protein_energy_landscape_diffwts.run_protein_energy_landscape_calc( Options.energy_fxn, restore, config, "protein-tilt-angle" )
        # Test #4: Membrane protein hydrophobic thickness
        if ( "hydrophobic-length" in test_names ): 

                predict_hydrophobic_length_diffwts.run_hydrophobic_length_calc( Options.energy_fxn, restore, config, "hydrophobic-length" )

        # Test #5: Stability of transmembrane peptides at neutral pH
        if ( "ddG-of-insertion" in test_names ): 
                if(Options.energy_fxn == "franklin2019"):
                        make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ddG-of-insertion", "stability/C4_polyLeu_helical_peptides", "tests/xml/make_depth_vs_tilt_energy_landscape_f19.xml" )

                else:
                        make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ddG-of-insertion", "stability/C4_polyLeu_helical_peptides", "tests/xml/make_depth_vs_tilt_energy_landscape.xml" )

        # Test #6: Stability of transmembrane peptides at acidic pH
        if ( "ddG-of-pH-insertion" in test_names ): 

                #make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ddG-of-pH-insertion", "stability/C5_pHLIP_helical_peptides", "tests/xml/make_depth_vs_tilt_pH_energy_landscape.xml", True, 4 )
                # if(Options.energy_fxn == "franklin2019"):
                #         make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ddG-of-pH-insertion", "../../../scratch16-jgray21/rsamant2/pHLIP_structures", "tests/xml/make_depth_vs_tilt_pH_energy_landscape_f19.xml", True, 4 )                   
                # else:
                #         make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ddG-of-pH-insertion", "../../../scratch16-jgray21/rsamant2/pHLIP_structures", "tests/xml/make_depth_vs_tilt_pH_energy_landscape.xml", True, 4 )
                #make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ddG-of-pH-insertion", "../../../scratch16-jgray21/rsamant2/pHLIP_structures", "tests/xml/make_depth_vs_tilt_pH_energy_landscape.xml", True, 8 )
                if(Options.energy_fxn == "franklin2019"):
                        make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ddG-of-pH-insertion","data/franklin2021/abinitio_structure_of_pHLIP", "tests/xml/make_depth_vs_tilt_pH_energy_landscape_f19.xml", True, 8 )                   
                else:
                        make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ddG-of-pH-insertion", "data/franklin2021/abinitio_structure_of_pHLIP", "tests/xml/make_depth_vs_tilt_pH_energy_landscape.xml", True, 8 )
                        make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ddG-of-pH-insertion", "../../../scratch16-jgray21/rsamant2/pHLIP_structures", "tests/xml/make_depth_vs_tilt_pH_energy_landscape.xml", True, 4 )
                
#                make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ddG-of-pH-insertion", "stability/C5_pHLIP_helical_peptides", "tests/xml/make_depth_vs_tilt_pH_energy_landscape.xml", True, 8 )
        
        print(test_names)
        # Test #6b: Titration and tilt angle of GWALP peptides
        if("ph-titration" in test_names):
                print("in the loop")
                # for iter in range( 1,29 ):
                #         make_peptide_energy_landscape_differentwts_titration.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ph-titration", "tilt_angle/A7_GWALP23", "tests/xml/make_depth_vs_helix_rot_energy_landscape_pH.xml", True, (iter)*0.50 )
                make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ph-titration", "tilt_angle/A7_GWALP23", "tests/xml/make_depth_vs_helix_rot_energy_landscape_pH.xml", True, 8 )
                make_peptide_energy_landscape_differentwts.run_peptide_energy_landscape_calc( Options.energy_fxn, config, "ph-titration", "tilt_angle/A7_GWALP23", "tests/xml/make_depth_vs_helix_rot_energy_landscape_pH.xml", True, 4 )
        ...
        if ( ("sequence-recovery" or "sc-distribution") in test_names ): 
                ...
                #make_designed_protein_scaffolds.run_fixed_backbone_design_calc( config, Options.energy_fxn,  "targets", "sequence-recovery", restore, "res_file_nonC" )
                # to sort score files to chose the best design
                 make_designed_protein_scaffolds.run_fixed_backbone_design_calc( config, Options.energy_fxn,  "targets", "sequence-recovery", restore, "res_file_nonC", analysis=True )
