...
def combiningallfiles(peptide_list, energy_fxn, test_name):
    ...
    for element_num in range(len(peptide_list)):
        ...
        start_index = ['-60.000000', '-50.000000', '-40.000000','-30.000000', '-20.000000', '-10.000000', '0.000000', '10.000000', '20.000000','30.000000', '40.000000', '50.000000']
        end_index = ['-50.000000', '-40.000000', '-30.000000','-20.000000', '-10.000000', '0.000000', '10.000000', '20.000000', '30.000000','40.000000', '50.000000', '60.000000']  # [-3, -2, -1, 0, 0, 0, 1, 2]
        ...
        if(peptide_name !="3tij_h1"):
            label0 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_' + \
                str(end_index[0])+'_'+str(start_index[0])+'_landscape.dat'
            df0 = pd.read_csv(label0)
            label1 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_' + \
                str(end_index[1])+'_'+str(start_index[1])+'_landscape.dat'
            df1 = pd.read_csv(label1)
            label2 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_' + \
                str(end_index[2])+'_'+str(start_index[2])+'_landscape.dat'
            df2 = pd.read_csv(label2)
            label3 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_' + \
                str(end_index[3])+'_'+str(start_index[3])+'_landscape.dat'
            df3 = pd.read_csv(label3)
            label4 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_' + \
                str(end_index[4])+'_'+str(start_index[4])+'_landscape.dat'
            df4 = pd.read_csv(label4)
            label5 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_'+ \
                str(end_index[5])+'_'+str(start_index[5])+'_landscape.dat'
            df5 = pd.read_csv(label5)
            label6 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_'+ \
            str(end_index[6])+'_'+str(start_index[6])+'_landscape.dat'
            df6 = pd.read_csv(label6)
            label7 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_'+ \
                str(end_index[7])+'_'+str(start_index[7])+'_landscape.dat'
            df7 = pd.read_csv(label7)
            label8 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_'+ \
                str(end_index[8])+'_'+str(start_index[8])+'_landscape.dat'
            df8 = pd.read_csv(label8)
            label9 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_'+ \
                str(end_index[9])+'_'+str(start_index[9])+'_landscape.dat'
            df9 = pd.read_csv(label9)
            label10 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_002_'+energy_fxn+'_'+ \
                str(end_index[10])+'_'+str(start_index[10])+'_landscape.dat'
            df10 = pd.read_csv(label10)

        else:
            label0 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_' + \
                str(end_index[0])+'_'+str(start_index[0])+'_landscape.dat'
            df0 = pd.read_csv(label0)
            label1 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_' + \
                str(end_index[1])+'_'+str(start_index[1])+'_landscape.dat'
            df1 = pd.read_csv(label1)
            label2 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_' + \
                str(end_index[2])+'_'+str(start_index[2])+'_landscape.dat'
            df2 = pd.read_csv(label2)
            label3 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_' + \
                str(end_index[3])+'_'+str(start_index[3])+'_landscape.dat'
            df3 = pd.read_csv(label3)
            label4 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_' + \
                str(end_index[4])+'_'+str(start_index[4])+'_landscape.dat'
            df4 = pd.read_csv(label4)
            label5 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_'+ \
                str(end_index[5])+'_'+str(start_index[5])+'_landscape.dat'
            df5 = pd.read_csv(label5)
            label6 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_'+ \
            str(end_index[6])+'_'+str(start_index[6])+'_landscape.dat'
            df6 = pd.read_csv(label6)
            label7 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_'+ \
                str(end_index[7])+'_'+str(start_index[7])+'_landscape.dat'
            df7 = pd.read_csv(label7)
            label8 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_'+ \
                str(end_index[8])+'_'+str(start_index[8])+'_landscape.dat'
            df8 = pd.read_csv(label8)
            label9 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_'+ \
                str(end_index[9])+'_'+str(start_index[9])+'_landscape.dat'
            df9 = pd.read_csv(label9)
            label10 = peptide_list[element_num]+'/'+peptide_name+'_relaxed_001_'+energy_fxn+'_'+ \
                str(end_index[10])+'_'+str(start_index[10])+'_landscape.dat'
            df10 = pd.read_csv(label10)
            
        df = pd.concat([df0, df1, df2, df3, df4, df5, df5, df6, df7, df8, df9, df10])
        ...
        for i in range(len(X)):
            ...
            for j in range(len(Y)):
                ...
                if(len(secondarr) == 0):
                    ...
                    mindata.append(secondarr.iloc[minpos, 0:27])
    ...
    if (Options.which_tests == "all"):
        ...
        for name in test_names:
            if name not in all_sub_tests:
                ...
                wt_fa_water_to_bilayer = ["0.966"]  # ,"0.90","1.1","1.3","1.5"]
                wt_fa_imm_elec = ["0.379"]  # ,"0.02","0.05","0.07","0.10"]
                wt_f_elec_bilayer = ["0.016"]  # ,"0.02","0.05","0.07","0.10"]
                    ...
                    for j in range(len(wt_f_elec_bilayer)):
                        for k in range(len(wt_fa_imm_elec)):
                            ...
                            if(name == "tm-peptide-tilt-angle"):
                                peptide_list = [
                                    '1a11', '1mp6', 'WALP23', '2nr1', 'polyA_cappedW', 'polyA_cappedY']
                            elif(name == "adsorbed-peptide-tilt-angle"):
                                peptide_list = [
                                    '1f0d', '1f0g', '1hu5', '1hu6', '1hu7', '2mag', 'LK_peptide_n6', '1fvn','2b4n','2khk','2mvm','2o8z','5xng']
